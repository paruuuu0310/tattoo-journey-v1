...
// テストポートフォリオデータ
export const testPortfolioItems: PortfolioItem[] = [
  {
    id: "portfolio-001",
    imageUrl:
...
export const competitorArtists: Artist[] = [
  {
    ...testArtist,
    uid: "test-artist-002",
